...
export const developments = [
  {
    ...
    short: "A student-led qualitative layer for Speak Up. A proposal is with their leadership; a student focus group is the next step.",
  ...
  },
  {
    ...
    short: "The twelve largest U.S. districts, public records only. Requests out to twenty systems; coding underway.",
  ...
  },
  {
    ...
    short: "A durable student AI structure with mentorship and continuity, under review. AI-Ignite 2027 is the first test if approved.",
